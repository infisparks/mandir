...
const FIREBASE_DB_URL = (process.env.FIREBASE_DATABASE_URL || process.env.NEXT_PUBLIC_FIREBASE_DATABASE_URL || "https://mandir-40825-default-rtdb.asia-southeast1.firebasedatabase.app").replace(/\/$/, "");
